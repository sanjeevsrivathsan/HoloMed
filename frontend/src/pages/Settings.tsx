...
import { Monitor, Sun, Moon, ScanLine, Bell, User } from 'lucide-react';
...
import { AiServicesCard } from '@/components/settings/AiServicesCard';
import { DemoDataCard } from '@/components/settings/DemoDataCard';

export function Settings({ onDataChanged }: { onDataChanged: () => Promise<void> | void }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <DemoDataCard onChanged={onDataChanged} />
